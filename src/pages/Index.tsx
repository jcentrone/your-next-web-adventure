        ...
        <div className="bg-background">
            ...
            <section id="hero" className="relative max-w-7xl mx-auto px-4 py-16 md:py-24 overflow-hidden">
                ...
                <div className="text-center max-w-4xl mx-auto">
                    <div className="flex items-center justify-center gap-2 mb-6">
                        ...
                        <div
                            className="inline-flex items-center gap-2 bg-green-500/10 text-green-600 px-3 py-1 rounded-full text-sm font-medium">
                            <CheckCircle className="w-4 h-4"/>
                            InterNACHI SOP Compliant
                        </div>
                        <div
                            className="inline-flex items-center gap-2 bg-amber-500/10 text-amber-600 px-3 py-1 rounded-full text-sm font-medium">
                    ...
                    <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                        From CRM and scheduling to professional reports and task management - everything you need to run
                        a successful
                        inspection business. Specialized for both home inspections and wind mitigation with advanced
            ...
            <section id="features" className="max-w-7xl mx-auto px-4 pb-16">
                <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground text-lg">
                        Advanced PWA technology meets specialized inspection workflows. Every feature designed for
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card
                        className="p-6 hover:shadow-lg transition-all duration-200 hover:scale-[1.02] border-primary/10">
                        ...
                        <p className="text-muted-foreground mb-4">
                            Install as native app on any device. Blazing fast performance with offline-first
                    ...
                    <Card
                        ...
                        <p className="text-muted-foreground mb-4">
                            Florida Form 1802 compliant wind mitigation inspections. Help clients save thousands on
                            insurance premiums.
                        </p>
                        <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-4">
                    ...
                    <Card
                        ...
                        <p className="text-muted-foreground mb-4">
                            Professional canvas tools for image markup. Draw, highlight, and annotate photos directly in
                            your reports.
                        </p>
                    ...
                    <Card
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <p className="text-muted-foreground mb-4">
                                Manage complex relationships between clients, realtors, vendors, and contractors with
                                advanced tracking.
                            </p>
                            <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-4">
                    ...
                    <Card
                        ...
                        <p className="text-muted-foreground mb-4">
                            Connect with Calendly, Acuity Scheduling, and more. Drag-drop calendar with external sync
                            capabilities.
                        </p>
                        <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-4">
                    ...
                    <Card
                        ...
                        <p className="text-muted-foreground mb-4">
                            Complete functionality without internet. Automatic background sync ensures no data loss
                            ever.
                        </p>
                        <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-4">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                            Experience the power of a native app without app store restrictions. Install directly from
                            your browser.
                        </p>
                    </div>
            ...
            <section className="max-w-7xl mx-auto px-4 py-16">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <div
                            className="inline-flex items-center gap-2 bg-amber-500/10 text-amber-600 px-3 py-1 rounded-full text-sm font-medium mb-4">
                            <Wind className="w-4 h-4"/>
                            Wind Mitigation Specialist
                        </div>
                        ...
                        <div className="group">
                            <div
                                className="w-16 h-16 rounded-2xl bg-muted/50 flex items-center justify-center mb-8 group-hover:bg-primary/10 transition-colors">
                                <Wind className="h-8 w-8 text-primary"/>
                            </div>
                            <h3 className="text-2xl font-medium mb-4">Uniform Mitigation</h3>
                            <p className="text-muted-foreground leading-relaxed mb-6">
                                Specialized uniform mitigation forms with OIR-B1-1802 compliance. Automated
                                calculations for insurance discounts.
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        <div className="text-center group">
                            <div
                                className="w-20 h-20 bg-gradient-to-br from-primary to-primary/80 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
                                <Users className="w-10 h-10 text-primary-foreground"/>
                            </div>
                            <h3 className="font-semibold mb-2 text-lg">1. Capture & Schedule</h3>
                            <p className="text-sm text-muted-foreground">
                                Mobile CRM with booking widget integration. Add contacts and schedule appointments
                                seamlessly.
                            </p>
                        </div>
                        ...
                        <div className="text-center group">
                            <div
                                className="w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
                        ...
                        <div className="text-center group">
                            <div
                                className="w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
                        ...
                        <div className="text-center group">
                            <div
                                className="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
                    ...
                    <div className="mt-12 grid md:grid-cols-3 gap-6">
                        ...
                        <Card
                            className="p-6 text-center bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
                        ...
                        <Card
                            className="p-6 text-center bg-gradient-to-br from-purple-50 to-violet-50 border-purple-200">
            ...
            <section id="templates" className="max-w-7xl mx-auto px-4 py-16">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-muted-foreground mb-6 text-lg">
                            Attorney-vetted narrative templates for each SOP section ensure consistent, professional
                            language.
                        ...
                        <div className="space-y-4 text-sm">
                            <div className="p-3 bg-muted/50 rounded">
                                ...
                                <p className="text-muted-foreground">
                                    "Multiple shingles are missing or damaged on the south-facing slope. This condition
                            ...
                            <div className="p-3 bg-muted/50 rounded">
                                ...
                                <p className="text-muted-foreground">
                                    "Open electrical junction box observed in basement. Recommend installing proper
                                    cover for safety..."
                                </p>
                            </div>
                            <div className="p-3 bg-muted/50 rounded">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-lg">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-muted-foreground">
                                Home Report Pro meets and exceeds industry standards for professional inspection
                                reporting
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-blue-700">Follows all Standards of Practice
                                        requirements
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-purple-700">Data privacy and protection compliance
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="max-w-7xl mx-auto px-4 py-16">
                <div
                    className="relative bg-gradient-to-br from-primary via-primary to-primary/80 rounded-3xl p-8 md:p-12 text-center overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mt-8 pt-8 border-t border-white/20">
                            <p className="text-white/80 text-sm">
                                ✓ No app store required ✓ Instant updates ✓ Works on all devices ✓ Full offline
                                capability
                            </p>
                        </div>
                    </div>
