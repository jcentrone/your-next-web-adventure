...
const ManufacturedHomeNew: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="New Manufactured Home Inspection Report"
        description="Create a new manufactured/mobile home insurance inspection report."
        canonical={window.location.origin + "/reports/new/manufactured-home"}
      />
      <section className="max-w-2xl mx-auto px-4 py-10">
        <h1 className="text-2xl font-semibold mb-6">New Manufactured Home Inspection Report</h1>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., 123 Main St Manufactured Home" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
...
export default ManufacturedHomeNew;
