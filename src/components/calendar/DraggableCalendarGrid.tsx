        ...
        return (
            <DragDropContext onDragEnd={handleDragEnd}>
                <div className="space-y-1">
                    <div
                        className="grid grid-cols-1 gap-0 max-h-[400px] overflow-y-auto border border-border rounded-lg">
                        {timeSlots.map((hour) => {
                            ...
                            return (
                                <Droppable key={hour} droppableId={slotDate.toISOString()}>
                                    {(provided, snapshot) => (
                                        ...
                                        >
                                            <div
                                                className="w-14 py-1 px-2 text-xs text-muted-foreground border-r border-border bg-muted/50">
                                                    ...
                                                    >
                                                        {(provided, snapshot) => (
                                                            <div
                                                                ...
                                                                className={cn(
                                                                    "py-1 px-2 rounded mb-1 cursor-pointer hover:opacity-10 transition-all text-xs border",
