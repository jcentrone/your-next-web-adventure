            ...
            <div className="relative flex-1 p-10 flex flex-col items-center text-center">
                ...
                {coverImage && (
                    <img
                        src={coverImage}
                        alt=""
                        className="z-20 w-full max-h-64 object-cover rounded border-4 border-white/20"
                    />
                )}
                <div className={"flex flex-col relative inset-0 z-20"}>

                    <h1 className="justify-center mt-6 text-4xl font-bold drop-shadow-lg">{reportTitle}</h1>
                    {organizationLogo && (
