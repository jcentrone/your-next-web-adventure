...
// Merge fields utility - moved from src/utils/replaceMergeFields.ts
...
const MERGE_FIELDS = Object.keys(MERGE_FIELD_MAP) as (keyof typeof MERGE_FIELD_MAP)[];

function replaceMergeFields(text: string, { organization, inspector, report }: MergeData) {
  if (!text) return "";
